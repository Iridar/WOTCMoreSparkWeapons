...
static function X2DataTemplate Create_Item()
{
	...
	Template.IncreaseGrenadeRadius = default.MAG_LAUNCHER_RADIUSBONUS;
	Template.IncreaseGrenadeRange = default.MAG_LAUNCHER_RANGEBONUS;

	Template.SetUIStatMarkup(class'XLocalizedData'.default.GrenadeRadiusBonusLabel, , default.MAG_LAUNCHER_RADIUSBONUS);
	Template.SetUIStatMarkup(class'XLocalizedData'.default.GrenadeRangeBonusLabel, , default.MAG_LAUNCHER_RANGEBONUS);
